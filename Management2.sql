...
alter table ReturnItem auto_increment = 1111111111;
...
alter table transactions auto_increment = 1000050432;

insert into transactions (NonVatTotal,TDate,TTime,VatAmount,TotalAmount,CashPaid,ChangeReceive,StaffID)
values(172.00,'September 20,2017','01:18 AM',28.00,200.00,250.00,50.00,1234567890);
...
CREATE TABLE transactiondetails (
  ...
  alter table transactiondetails auto_increment = 1000000000;

insert into transactiondetails (InvoiceNo,Product_ID,Prod_desc,UnitPrice,Price,Quantity,Discount,transaction_type,Customer_Name)
values(1000050432,'185867597','Cesar Beef',200,200,1,0,'Products','Charlie Borbe'),
(1000050433,'185867598','Cesar Beef',200,200,1,0,'Services','Charlie Borbe'),
(1000050434,'185867598','Cesar Beef',200,200,1,0,'Rooms','Charlie Borbe');

DROP TABLE IF EXISTS vatsetting;
CREATE TABLE vatsetting (
  VatID int(10) unsigned NOT NULL auto_increment,
  VatPercent varchar(20),
  PRIMARY KEY  (VatID));
  
alter table vatsetting auto_increment = 1000100000;
  
insert into vatsetting (VatPercent)
values(0.12);
...
alter table TAXRECORD auto_increment = 1222222222;
  
insert into TAXRECORD (InvoiceNo,VatAmount,TDate)
values(1045238584,'566.4','September 06, 2017'); 
...
alter table Test auto_increment = 1222222222;
  
insert into Test (InvoiceNo,VatAmount,TDate)
values(1045238584,20,'September 06, 2017'); 
...
alter table PetInfo auto_increment = 1212121212;

insert into PetInfo (Customer_ID,Customer_Name,Pet_Name,Breed)
values(1785496823,'Charlie Borbe','Butchoy','Siberian Husky'); 
...
alter table Stocks auto_increment = 1010101010;